...
exports.getFiltered = ({ date_time_lo, date_time_hi, status }: any) => {
  // status: number[]
...
exports.create = async (order: any) => {
...
exports.createOrder2Product = async (order: any) => {
...
exports.getProductsInOrderById = async (order_id: any) => {
...
exports.getByUuid = async (uuid: string) => {
...
exports.updateStatus = ( id: number, status: 0 | 1 | 2 | 3 | 4 ) => {
  // id:      number
  // status:  0 | 1 | 2 | 3 | 4
