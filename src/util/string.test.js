...
describe('util/string.js', () => {
  ...
  it('truncateFront()', async () => {
    // ('123456789')    =>   "...456789"
    expect( truncateFront({ str: '123456789' }) ).toBe("...456789");

    // ('123456789', 1)    =>   "...9"
    expect( truncateFront({ str: '123456789', len: 1 }) ).toBe("...9");

    // ('123456789', 2)    =>   "...89"
    expect( truncateFront({ str: '123456789', len: 2 }) ).toBe("...89");

    // ('123456789', 8)    =>   "...23456789"
    expect( truncateFront({ str: '123456789', len: 8 }) ).toBe("...23456789");
  });
